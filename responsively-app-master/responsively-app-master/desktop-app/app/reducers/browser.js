...
export function getDefaultDevToolsWindowSize(mode, windowSize) {
  ...
  if (mode === DEVTOOLS_MODES.RIGHT) {
  	...
  	console.log("Expeected: 360");
  	console.log(Math.round(width * .25));
  	console.log("Windowsize: height");
  	console.log("Expeected: 814");
  	console.log(Math.round(height));
  	//old code
    return {width: Math.round(width * 0.25), height};
	//new code
	//return {width: Math.round(width * 0.25), height: Math.round(height * .80)};
  }
